...
//! let language = tree_sitter_angelscript::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading Angelscript parser");
...
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_angelscript) };
